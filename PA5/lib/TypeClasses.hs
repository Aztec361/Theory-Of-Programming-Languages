...
dOrdXY dictA dictB = MkOrd (\(a1, b1) (a2, b2) ->
    case compare dictA a1 a2 of
        EQ -> compare dictB b1 b2
        r -> r
    )
-- <FILL-IN>
...
dOrdYX dictA dictB = MkOrd (\(a1, b1) (a2, b2) ->
  case (compare dictB) b1 b2 of
    EQ -> (compare dictA) a1 a2
    r -> r
  )
